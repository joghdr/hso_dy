...
file="./results/E288_control_ninv_fast/./stat//E605//E605_800_8-9.stat"

set title  "E605 800 8-9"
set xlabel "q_T[GeV]"
set ylabel "csec"

set label 'E=800 GeV'  at screen 0.7,screen 0.7
set label '8<Q<9 GeV'  at screen 0.7,screen 0.65
...
plot[xmin-xdel:xmax+xdel][ymin-ydel:ymax+ydel] \
    ...
    file u 1:4 :5 w err pt 13 lc "dark-blue"  t "E605 800 8-9",\
