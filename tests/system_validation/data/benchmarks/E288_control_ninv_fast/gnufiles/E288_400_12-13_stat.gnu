...
file="./results/E288_control_ninv_fast/./stat//E288//E288_400_12-13.stat"

set title  "E288 400 12-13"
set xlabel "q_T[GeV]"
set ylabel "csec"

set label 'E=400 GeV GeV'  at screen 0.7,screen 0.7
set label '12<Q<13 GeV GeV'  at screen 0.7,screen 0.65
...
plot[xmin-xdel:xmax+xdel][ymin-ydel:ymax+ydel] \
    ...
    file u 1:4 :5 w err pt 13 lc "dark-blue"  t "E288 400 12-13",\
