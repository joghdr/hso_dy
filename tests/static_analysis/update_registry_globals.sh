...
print_msg "--> BINARIES_PATH =  ${BINARIES_PATH}"



print_msg "--> Printing binaries registry to ${globals_registry_file}"
print_msg "--> Printing exec registry to ${globals_registry_file_app}"
